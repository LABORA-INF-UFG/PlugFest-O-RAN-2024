...
```
We must clone the Non-RT RIC by following the steps described <a href="https://wiki.o-ran-sc.org/display/RICNR/Release+I+-+Run+in+Kubernetes#:~:text=helm/chartmuseum)-,Preparations,-Download%20the%20the">here</a>
